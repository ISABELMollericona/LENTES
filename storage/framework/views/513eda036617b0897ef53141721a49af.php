<nav class="navbar navbar-dark px-3" style="background: #1a1a1a; border-bottom: 1px solid #333;">
    ...
    <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end">
            <li><a class="dropdown-item" href="<?php echo e(route('profile.edit')); ?>"><i class="bi bi-person me-2"></i>Mi perfil</a></li>
...
<?php /**PATH C:\Users\MOLLERICONA\Downloads\LENTES UPDS\resources\views/partials/admin-navbar.blade.php ENDPATH**/ ?>