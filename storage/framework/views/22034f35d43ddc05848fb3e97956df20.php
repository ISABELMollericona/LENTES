...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="text-center mb-3">
                            <a href="<?php echo e(route('password.request')); ?>" class="text-decoration-none" style="color: #D4AF37;">
                                ¿Olvidaste tu contraseña?
                            </a>
                        </div>

                        <hr class="my-3">
                        <a href="<?php echo e(route('auth.google')); ?>" class="btn btn-outline-dark w-100 py-2 mb-3 d-flex align-items-center justify-content-center gap-2">
            ...
            <div class="text-center mt-3">
                <p class="text-muted">
                    ¿No tienes cuenta?
                    <a href="<?php echo e(route('register')); ?>" class="fw-bold text-decoration-none" style="color: #D4AF37;">Regístrate aquí</a>
                </p>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\MOLLERICONA\Downloads\LENTES UPDS\resources\views/auth/login.blade.php ENDPATH**/ ?>