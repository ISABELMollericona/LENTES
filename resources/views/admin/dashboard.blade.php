            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <div class="kpi-value"><span class="counter-value" data-target="{{ $dashboard['usuarios_registrados'] }}" data-duration="1200">0</span></div>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <div class="kpi-value" style="color: #2b8a3e;"><span class="counter-value" data-target="{{ $dashboard['lentes_disponibles'] }}" data-duration="1200">0</span></div>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <div class="kpi-value" style="color: #c92a2a;"><span class="counter-value" data-target="{{ $dashboard['lentes_vendidos'] }}" data-duration="1200">0</span></div>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <div class="kpi-value">Bs <span class="counter-value" data-target="{{ $dashboard['ingresos_totales'] }}" data-duration="1500" data-suffix="">0</span></div>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <div class="kpi-value"><span class="counter-value" data-target="{{ $dashboard['pedidos_realizados'] }}" data-duration="1200">0</span></div>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <div class="kpi-value"><span class="counter-value" data-target="{{ $dashboard['ventas_totales'] }}" data-duration="1200">0</span></div>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <div class="kpi-value"><span class="counter-value" data-target="{{ $dashboard['recomendaciones_realizadas'] }}" data-duration="1200">0</span></div>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <div class="kpi-value"><span class="counter-value" data-target="{{ $dashboard['analisis_faciales'] }}" data-duration="1200">0</span></div>
                    </div>
