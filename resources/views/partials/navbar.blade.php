<nav class="navbar navbar-expand-lg navbar-dark navbar-golden sticky-top shadow-lg">
    <div class="container-fluid px-4 px-lg-5">
        <a class="navbar-brand fw-bold" href="{{ route('home') }}" style="color: #D4AF37 !important; font-size: 1.2rem; letter-spacing: 1px;">
        ...
        <div class="collapse navbar-collapse" id="navbarMain">
            <ul class="navbar-nav me-auto">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('catalogo.index') }}" style="color: #d0d0d0;">
                        <i class="bi bi-grid me-1"></i>Catálogo
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('catalogo.index', ['categoria' => 'sol']) }}" style="color: #d0d0d0;">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('asesor.index') }}" style="color: #d0d0d0;">
                        <i class="bi bi-robot me-1"></i>Asesor Virtual
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('facial.index') }}" style="color: #d0d0d0;">
            ...
            <ul class="navbar-nav ms-auto">
                @auth
                <li class="nav-item">
                    <a class="nav-link position-relative" href="{{ route('carrito.index') }}" style="color: #d0d0d0;">
                        ...
                        <span class="badge position-absolute top-0 start-100 translate-middle" style="background: #D4AF37; color: #1a1a1a; font-weight: 600;" id="cart-count">
                            {{ \App\Services\CartService::contarStatic(auth()->id()) }}
                        </span>
                    </a>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark dropdown-menu-end" style="background: #1a1a1a; border: 1px solid rgba(212, 175, 55, 0.2);">
                        <li><a class="dropdown-item" href="{{ route('profile.edit') }}" style="color: #d0d0d0;"><i class="bi bi-person me-2"></i>Mi Perfil</a></li>
                        <li><a class="dropdown-item" href="{{ route('pedidos.index') }}" style="color: #d0d0d0;"><i class="bi bi-box me-2"></i>Mis Pedidos</a></li>
                        @if(auth()->user()->esAdmin())
                        <li><hr class="dropdown-divider" style="border-color: rgba(212, 175, 55, 0.2);"></li>
                        <li><a class="dropdown-item" href="{{ route('admin.dashboard') }}" style="color: #d0d0d0;"><i class="bi bi-speedometer2 me-2"></i>Admin Panel</a></li>
                        @endif
                        <li><hr class="dropdown-divider" style="border-color: rgba(212, 175, 55, 0.2);"></li>
                        <li>
                ...
                @else
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('login') }}" style="color: #d0d0d0;">
                        <i class="bi bi-box-arrow-in-right me-2"></i>Iniciar Sesión
                    </a>
                </li>
                <li class="nav-item">
                    <a class="btn btn-gold px-3 fw-semibold ms-2" style="border-radius: 6px; transition: all 0.3s ease;" href="{{ route('register') }}">Registrarse</a>
                </li>
                @endauth
            </ul>
        </div>
